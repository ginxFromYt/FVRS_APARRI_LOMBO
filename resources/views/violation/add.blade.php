<x-app-layout>
    ...
    <div class="container mt-2">
        <h2 class="table-title">Record a Violation</h2>
        ...
        <div class="form-container">
            <form action="{{ route('violation.storeManuallyInputtedViolators') }}" method="POST" class="bg-white p-4 rounded shadow">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <input type="date" name="date_of_violation" class="form-control" required>
                </div>

                <div class="form-group">
                    <label for="time_of_violation">Time of Violation:</label>
                    <input type="text" name="time_of_violation" class="form-control" required>
                </div>
                ...
                <div id="violator-fields">
                    <div class="violator">
                        <div class="form-group">
                            ...
                            <input type="text" name="violators[0][violator]" class="form-control" placeholder="Enter full name" required>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="violators[0][address]" class="form-control" required>
                        </div>
                    </div>
                </div>
    ...
    <script>
        ...
        document.getElementById('add-violator').addEventListener('click', function() {
            ...
            violatorDiv.innerHTML = `
                <div class="form-group">
                    <label for="violator">Violator:</label>
                    <input type="text" name="violators[${violatorCount}][violator]" class="form-control" placeholder="Enter full name" required>
                </div>
                <div class="form-group">
                    <label for="sex">Sex:</label>
