...
<head>
    ...
    <style>
        ...
        .container-content {
            ...
            margin-left: 0;
            padding-top: 60px; /* Added padding to accommodate the notification bar */
        }
...
<div class="container-content">
    <div class="notification-box">
        ...
        <a href="{{ route('report.userreports') }}" class="btn" style="margin: 0; padding: 0;">
            ...
            <span id="notificationCount" class="badge bg-success">{{ \App\Models\UserReport::count() }}</span> <!-- Total count of reports -->
        </a>
    </div>
    ...
    <div class="center-container">
        ...
        <p class="text-center mt-4" style="font-family: 'Merriweather', serif; font-size: 20px; color: white; background-color: rgba(0, 0, 0, 0.7); border: 2px solid navy; padding: 20px; border-radius: 15px; max-width: 600px; margin: 0 auto;">
            Welcome to the <strong>Fisherfolks Violations Records System</strong>.<br>
            As part of our efforts to preserve maritime safety and integrity, please ensure to report any violations you observe.
        </p>
