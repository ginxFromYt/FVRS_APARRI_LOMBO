...
<head>
    ...
    <title>Maritime Incident Report</title>
...
<style>
    ...
    .header-section .org-info h5, .header-section .org-info p {
        margin: 0;
    }
...
<body>
    <div class="thin-container">
        <h5 class="container-text" style="color: white;">Municipal Agriculture Office-Aparri</h5>
    </div>
<div class="control-panel">
        <div class="control-panel-header text-center">
            ...
            <h2 class="control-panel-title" style="font-size: 1.25rem; ">Spot and Referrals</h2>
        </div>
        ...
        <div class="modal-content">
            <div class="modal-body" id="feedbackDetails">
                ...
                <div id="memorandumTemplate">
                    ...
                    <p id="subjectLine">SUBJECT: Spot Report re Violation of Section 33 Municipal Ordinance No. 2015-152 (Unauthorized fishing activities) of Aparri, Cagayan against <span id="skipperNameSubject"></span></p>
                    <p>DATE: <span id="reportDate"></span></p>
                    <p>2. In connection with the above references please be informed that on <span id="dateOfViolationSubject"></span> at about <span id="timeSubject"></span> personnel of Aparri MLET led by PSMS Herold D Alviar, conducted seaborne patrol operation along Cagayan River of Brgy. Macanaya, Minanga, Punta, Sanja and Bisagu Aparri, Cagayan which resulted to the apprehension of One (1) Motorized Fishing Banca for Violation of Section 33 Municipal Ordinance No. 2015-152 (Unauthorized fishing activities) of Aparri, Cagayan in relation to EO.305.</p>
                </div>
                ...
                <p>3. The apprehended motorized Fishing banca's and boat skippers were brought to Aparri MLET for documentation and prior to referred to Municipal Agriculturist Office for Proper Disposition. (See attached photos).</p>
