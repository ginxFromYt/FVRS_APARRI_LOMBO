...
<div class="thin-container" style="background-color: #333; color: #4CAF50; position: fixed; top: 0; left: 0; width: 100%; z-index: 101; padding: 10px 0; text-align: center;">
    <h5 class="container-text" style="margin: 0; font-size: 1.2rem;">Municipal Agriculture Office-Aparri</h5>
</div>
